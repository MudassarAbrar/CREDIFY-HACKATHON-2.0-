...
export const ArcGalleryHero: React.FC<ArcGalleryHeroProps> = ({
  ...
  return (
    <section className={`relative overflow-hidden bg-white dark:bg-gray-900 text-gray-900 dark:text-white min-h-[85vh] flex flex-col ${className}`}>
              ...
              >
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).src = `https://placehold.co/400x400/334155/e2e8f0?text=Skill`;
                    }}
                  />
                </div>
              </div>
      ...
      {/* Content positioned below the arc - pulled up for better balance */}
      <div className="relative z-10 flex-1 flex items-center justify-center px-6 -mt-52 md:-mt-64 lg:-mt-80">
