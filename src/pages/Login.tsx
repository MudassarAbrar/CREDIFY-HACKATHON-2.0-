      ...
      <Card className="w-full max-w-sm">
        ...
        <CardContent>
          ...
          <div className="relative my-6">
            ...
            <div className="mt-5 flex justify-center min-h-[44px] w-full">
              {googleClientId ? (
                <div
                  ref={googleButtonRef}
                  id="google-signin-button"
                  className="min-w-[240px] min-h-[44px] [&>div]:!min-w-[240px] [&>div]:!min-h-[44px] [&>iframe]:!min-w-[240px] [&>iframe]:!min-h-[44px]"
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="min-w-[240px] gap-2 h-11"
                  onClick={() =>
                    toast({
